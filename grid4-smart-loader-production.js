...
window.addEventListener('load', function() {
    ...
    const VERSIONS = {
        'v1-stable': {
            name: 'v1.2.2 Emergency Icon Fix',
            css: [
                ...
                `https://cdn.statically.io/gh/paulhshort/grid4-netsapiens-skin/main/grid4-emergency-icon-fix.css?v=${CACHE_BUST}&r=${SECONDARY_BUST}`
            ],
